...
public class ResultWrapper implements Serializable {
     ...
     * The result.
     */
    private List<AnnotatedObject> myResults;
     ...
     */
    public ResultWrapper(Collection<AnnotatedObject> results, int maxSize) {
        this(results, results.size(), maxSize);
        this.totalResultsCount = results.size();
    }

    public ResultWrapper(Collection<AnnotatedObject> results, int maxSize, Map<String,Integer> info) {
        this(results, results.size(), info, maxSize);
    }

    public ResultWrapper(Collection<AnnotatedObject> results, int maxSize, Map<String,Integer> info, int totalResultsCount) {
        this(results, results.size(), maxSize);
        this.myInfo = info;
     ...
     */
    public List<AnnotatedObject> getResult() {
        if (myResults == null) {
    ...
    private ResultWrapper(Collection<AnnotatedObject> results, int potentialSize, int maxSize) {
        myResults = (List<AnnotatedObject>) results;
