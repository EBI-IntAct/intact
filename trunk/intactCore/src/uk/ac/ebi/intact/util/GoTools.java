...
public class GoTools {
    ...
    /**
     * If true, delete old references from a CvObject during an update.
     */
    private static final boolean DELETEREFERENCES = true;
    ...
    private static void insertDefinition (Hashtable definition,
        ...
        */
        ...
        CvObject current = (CvObject)helper.getObjectByXref(targetClass,
     ...
     */
    public static void insertGoDefinitions (String aSourceUrl,
                                            IntactHelper helper,
                                            Class aTargetClass) throws Exception {
     ...
     */
    public static void writeGoDefinitions(IntactHelper helper,
                                          Class aTargetClass)
        throws IntactException {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Read definitins
        insertGoDefinitions("file:///homes/hhe/tmp/GO_small.defs", helper, CvInteractionType.class);

        // Write definitions for verification
        writeGoDefinitions(helper,
                CvInteractionType.class);
