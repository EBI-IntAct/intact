...
public class ObjectBridgeDAO implements DAO, Serializable {
    ...
    /**
     * Used to access different descriptors from OJB
     */
    private MetadataManager metaData;

    /**
     * The default OJB Broker key - generated by the default repository data
     */
    ...
    public ObjectBridgeDAO(PersistenceBroker broker) {
        ...
        repositoryFile = broker.getPBKey().getAlias();  //alias instead of repositoryfile name
...
//        String knownPassword = DescriptorRepository.getDefaultInstance().getDefaultJdbcConnection().getPassWord();
        ...
        //NB not sure if using the default PBKey is correct - really should use
        //the jcdAlias but don't know how to get at it!
        JdbcConnectionDescriptor connDesc = metaData.connectionRepository().getDescriptor(defaultKey);
        String knownUser = connDesc.getUserName();
        String knownPassword = connDesc.getPassWord();
        if (userName.equals(knownUser)) {
            //check password - could be null..
            if (((password == null) & (knownPassword == null)) ||
                    (password.equals(knownPassword)))
                return true;
        }
        return false;
    }
...
//        JdbcConnectionDescriptor jDesc = DescriptorRepository.getDefaultInstance().getDefaultJdbcConnection();
        JdbcConnectionDescriptor jDesc = metaData.connectionRepository().getDescriptor(defaultKey);
...
//            if (dummy == null) {
//                // Has a primary key but unknown to the DB.
...
//    }
    ...
    private Query buildQueryByExample(Object obj) {
        ...
        ClassDescriptor cld = metaData.getRepository().getDescriptorFor(obj.getClass());
            ...
            */
            ...
            if (collection != null) {
                ...
                if (it.hasNext()) {
                    ...
                    ClassDescriptor elemDesc = metaData.getRepository().getDescriptorFor(element.getClass());
        ...
        */
        ...
        if (collection != null) {
            ...
            if (it.hasNext()) {
                ...
                Object elem = it.next();
                ClassDescriptor elemDesc = metaData.getRepository().getDescriptorFor(elem.getClass());
       ...
       */
        ...
        try {
            ...
            if (value != null) {
                ...
                ClassDescriptor valueCd = metaData.getRepository().getDescriptorFor(value.getClass());
    ...
    private ClassDescriptor getClassDescriptor(Class clazz) {
        return (metaData.getRepository().getDescriptorFor(clazz));
    }
