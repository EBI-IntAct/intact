...
public class InteractionTest extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite( uk.ac.ebi.intact.model.test.InteractionTest.class );
    }
    ...
    public void doCloneTest1() throws IntactException, CloneNotSupportedException {
        ...
        InteractionImpl orig = (InteractionImpl) helper.getObjectByLabel( Interaction.class, "ga-3" );
    ...
    public void doCloneTest2() throws IntactException, CloneNotSupportedException {
        IntactHelper helper = myTestHelper.getHelper();
        InteractionImpl orig = (InteractionImpl) helper.getObjectByLabel( Interaction.class, "ga-1" );
