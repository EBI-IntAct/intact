 ...
 */
package uk.ac.ebi.intact.application.imex.keyassigner;

import org.apache.axis.client.Stub;
import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import uk.ac.ebi.intact.application.imex.helpers.IMExHelper;
import uk.ac.ebi.intact.application.imex.id.IMExRange;
import uk.ac.ebi.intact.application.imex.keyassigner.generated.RegIMExService;
import uk.ac.ebi.intact.application.imex.keyassigner.generated.RegIMExServiceLocator;
import uk.ac.ebi.intact.application.imex.keyassigner.generated.RegIMEx_PortType;
import uk.ac.ebi.intact.application.imex.keyassigner.generated.SubmissionAxis;
        ...
        try {
            ...
            if ( helper != null ) {
                try {
                    ...
                    log.error( "An exception was thrown when closing IntactHelper. Cf. nested Exceptions.", e );
                }
            }
        }
    }
