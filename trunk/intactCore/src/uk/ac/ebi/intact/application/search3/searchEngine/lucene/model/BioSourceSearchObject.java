...
public class BioSourceSearchObject extends SearchObject {
     ...
     * @param xrefs       Map with xrefs that a specific biosource has. The key is the name of the database and
     *                    the value is the primaryId of the reference
     * @param annotations Map with annotations for a specific biosource, the key is the name of the cvTopic and
