...
public class IMExHelper {
     ...
     */
    public static CvDatabase whoAmI( IntactHelper helper ) throws IntactException {

        CvDatabase psi = CvHelper.getPsi( helper );
        CvXrefQualifier identity = CvHelper.getIdentity( helper );
        ...
        // search for it
        Collection<CvDatabase> databases = helper.getObjectsByXref( CvDatabase.class, psi, identity, psiId );
