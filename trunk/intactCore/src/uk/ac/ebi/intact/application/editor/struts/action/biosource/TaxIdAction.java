...
package uk.ac.ebi.intact.application.editor.struts.action.biosource;
 ...
 * @version $Id$
 */
public class TaxIdAction extends AbstractEditorAction {
    ...
    public ActionForward execute(ActionMapping mapping,
        ...
        // This can crash the application but it should never happen as we had
        // already created the correct editor view bean.
        BioSourceEditViewBean bioview = (BioSourceEditViewBean) user.getView();
     ...
     * otherwise.
     */
    private XreferenceBean findXref(String dbname, BioSourceEditViewBean bioview) {
        // The xrefs to loop.
