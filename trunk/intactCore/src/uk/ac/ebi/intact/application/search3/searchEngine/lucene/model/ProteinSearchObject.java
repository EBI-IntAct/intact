...
/**
 * This class provides a possibility to store the attributes of a Protein to create an index
 *
...
//                               final String fullName, final String objClass, final String role,
//                               final Map xrefs) {
//
...
//    }
    ...
    /**
     * constructor to hold the set of information for one protein
     *
     ...
     * @param xrefs       Map with xrefs that a specific protein has. The key is the name of the database and
     *                    the value is the primaryId of the reference
     * @param annotations Map with annotations for a specific protein, the key is the name of the cvTopic and
