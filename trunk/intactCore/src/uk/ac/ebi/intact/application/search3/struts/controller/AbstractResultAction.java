...
public abstract class AbstractResultAction extends SearchBaseAction {
    ...
    /**
     * This abstract method is process the request more effectively. It avoids making any
     * assumptions about the beans or the size of search result list and keep all of the
