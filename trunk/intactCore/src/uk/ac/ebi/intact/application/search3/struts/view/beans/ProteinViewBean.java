...
public class ProteinViewBean extends AbstractViewBean {
    ...
    public String getProteinSearchURL() {
        ...
        if ( protSearchURL == null ) {
            //set it on the first call
            protSearchURL = searchURL + protein.getAc() + "&amp;searchClass=Protein&amp;filter=ac";
        }
    ...
    public int getInteractionsCount() {
        ...
        Set interactions = new HashSet( protein.getActiveInstances().size() );
        for ( Iterator iterator = protein.getActiveInstances().iterator(); iterator.hasNext(); ) {
    ...
    public String getBinaryViewUrl() {
        return ( searchURL + protein.getAc() + "&amp;filter=ac&amp;searchClass=Protein&amp;view=partner" );
    }
}
