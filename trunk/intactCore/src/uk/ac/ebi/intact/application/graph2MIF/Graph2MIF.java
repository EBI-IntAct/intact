...
public class Graph2MIF {
     ...
     */
    public Graph2MIF(Boolean strictmif) {
    ...
    public Document getMIF(Graph graph) throws GraphNotConvertableException {
        ...
        psiEntrySet.setAttribute("xsi:schemaLocation", "net:sf:psidev:mi http://psidev.sourcefroge.net/mi/xml/src/MIF.xsd");
    ...
    /**
     * process cvInteraction
     * @param cvInteraction to convert to PSI-Format
     * @return DOM-Object, representing a <interactionDetection>
     * @exception ElementNotParseableError if PSIrequired Elements are missing within graph
     * @see uk.ac.ebi.intact.model.CvInteraction
     */
    private Element procCvInteraction(CvInteraction cvInteraction) throws ElementNotParseableError {
        //generate DOM-Element
    ...
    private Element procXrefCollection(Collection xrefs) throws ElementNotParseableError {
        ...
        while (iteratorSnd.hasNext()) {
            ...
            try {
                ...
                System.out.println("Xref without primary db or id found ! Ignoring !"); // not required here - so dont worry
            } catch (ElementNotParseableError e) {
                System.out.println("Xref without primary db or id found ! Ignoring !"); // not required here - so dont worry
            }
        }
...
////////////////THIS method th mainly the same like  procBioSource down ...psiElement diffs !
    ...
    private Collection getRelInteractionTypes(Collection relExperiments) {
        Collection relInteractionTypes = new Vector();
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Execption if some required elements (of PSI) are missing in a IntactGraphObject ...
