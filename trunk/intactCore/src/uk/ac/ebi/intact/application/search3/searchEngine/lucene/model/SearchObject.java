...
/**
 * This class provides method to get the information of a search object
 *
...
public class SearchObject {
    ...
    // the short label of one search object
    private String shortLabel;

    // the fullname/description of one search object
    private String fullName;

    // the IntAct class name of that specific search object
    ...
    /**
     * constuctor to provide the information of one search object
     ...
     * @param xrefs          Map holding the cross references for one search object, the key is the database name and
     *                       the value is a collection of the primaryIds
     ...
     * @param alias          Map holding the alias for one search object, the key is the name of the alias type and the value
     *                       is a collection of the alias names
     */
