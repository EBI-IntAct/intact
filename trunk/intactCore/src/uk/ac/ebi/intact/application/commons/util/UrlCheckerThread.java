...
public class UrlCheckerThread extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            } else if ( aUrl.getProtocol().equals( PROTOCOL_FTP ) ) {
                isValidUrl = checkUrl( aUrl );
            } else {
                // unsupported protocol
                System.out.println( "Unsupported protocol: " + aUrl.getProtocol() );
                isValidUrl = false;
            }
    ...
    private boolean checkHttpUrl( String aUrl ) {
        ...
        System.out.println( "checkHttpUrl-ing" );
    ...
    private boolean checkUrl( URL aUrl ) {
        ...
        System.out.println( "checkUrl-ing" );
        ...
        if ( ! finished ) {
            try {
                if ( waitIfNotFinished > 0 ) {
                    ...
                    Thread.currentThread().sleep( waitIfNotFinished );
                }
