...
/**
 * Dummy Servlet Context to be able to run the testfill.sh script without using a web app.
 * Only setAttribute and getAttribute are implemented. The other methods throw an
