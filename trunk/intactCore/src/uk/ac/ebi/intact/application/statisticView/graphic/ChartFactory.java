...
public class ChartFactory {
     ...
     * @param rotateLabel a boolean which descripes if the labels should rotate which 3 degree used for long names in the Dataset
     *                    true means rotate the label. false means not to rotate the label
