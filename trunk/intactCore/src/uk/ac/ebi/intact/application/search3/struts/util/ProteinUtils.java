...
public class ProteinUtils {
    ...
    /**
     * Returns a collection containing the self interactions of the give protein. A Self Interaction
     * is an Interaction which got 2 or lesser Compoenents and the sum of the stoichemetry is 2.
     *
     * @param aProtein a protein, must no be null
