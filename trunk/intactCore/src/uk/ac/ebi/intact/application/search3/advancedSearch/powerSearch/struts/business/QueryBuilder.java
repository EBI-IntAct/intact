...
public class QueryBuilder {
    ...
    /**
     * This method builds the search condition out of the value and the term.
     * If the value contains commas it is an multi-value and the parts of this value should be connected with 'or'
     * If the value contains plus it is an multi-value and the parts of this value should be connected with 'and'
     * Otherwise it is a single value and can be send to the method buildSingleCondition()
     *
    ...
    public String buildCondition(int term, String value) throws IntactException {
        if (value == null) throw new NullPointerException("value is not allowed to be null ");
        if (!((0 < term) && (term <= MAX_NUMBER_OF_TERMS))) throw new NullPointerException(" that term is not specified");
        ...
        if (value.matches(".+,.+")) {
            ...
            if (value.matches(".+\\+.+")) throw new IntactException("no combination of plus and comma please!");
    ...
    /**
     * take the term and value and build a single search condition out of it.
     * If the value contains a asterix choose the comparisor 'like' otherwise choose '='.
     * If the value contains any 'forbidden' sign replace it with a whitespace
     *
     * @param term  the search term of the condition
     * @param value the value of the search condition
    ...
    /**
     * this method gets one shortlabel, which should be a CVDagObject shortlabel and creates
     * an IQL condition that searches also for all children of this CvDagObject
