...
/**
 * This class gets the search information out of the web form, converts it into an IQL statement and retrives the results.
 * Having the results it forwards to the AdvDispatcherAction
 *
...
//        }
    ...
    /**
     * this method searches the database with the given iql query and returns a collection with all located
     * ac numbers and their objclass.
     *
     ...
     * @return  a map with all intact objects corresponding to the searchKeys, the map will have the name
     *          of the searchobjects (e.g. experiment) as keys and all found intact objects (e.g all experiment objects)
     *          as value
     * @throws IntactException
     */
