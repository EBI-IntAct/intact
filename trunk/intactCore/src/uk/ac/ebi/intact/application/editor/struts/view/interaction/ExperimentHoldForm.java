...
/**
 * The form to display experiments on hold for an Interaction.
 *
 * @author Sugath Mudali (smudali@ebi.ac.uk)
 * @version $Id$
 */
public class ExperimentHoldForm extends EditForm {

    /**
     * Sets the experiments on hold for the form to retrieve.
