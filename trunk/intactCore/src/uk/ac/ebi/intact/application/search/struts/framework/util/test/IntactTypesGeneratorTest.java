 ...
 * $Id$
 */
package uk.ac.ebi.intact.application.search.struts.framework.util.test;

import java.util.*;
import java.io.*;

import junit.framework.*;
import uk.ac.ebi.intact.application.search.struts.framework.util.IntactTypesGenerator;
 ...
 * @version $Id$
 */
public class IntactTypesGeneratorTest extends TestCase {

    /**
     * Constructor with the test name.
     * @param name the name of the test.
     */
    public IntactTypesGeneratorTest(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        return new TestSuite(IntactTypesGeneratorTest.class);
    }
    ...
    public void testDoIt() {
        ...
        String resPath = "../../src/uk/ac/ebi/intact/application/search/struts/framework/util/test/";
        ...
        String expResource = resPath + "ExpectedIntactTypes.properties";
