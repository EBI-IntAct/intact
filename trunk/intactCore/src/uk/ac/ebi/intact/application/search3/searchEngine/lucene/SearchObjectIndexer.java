...
/**
 * This class provides methods to create a lucene index for the search objects (Experiment, Interaction, Protein, CvObject)
 * and to transform a IntAct object into a Lucene document.
 * It contains different methods for different indexing proceeding. The fastest index proceeding is the one using the RAM directory.
 *
...
public class SearchObjectIndexer {
    ...
    // object to controlle the synchronization
    ...
    /**
     * This method is just a dispatcher that chooses the right indexing method for the
     * specific search object.
     * It is only used for the simple indexing.
     *
     ...
     * respective method to transform them into a lucene document
     * It is used for the indexing using the RAM directory.
     *
    ...
    /**
     * This method creates a Lucene document from a protein search object.
     * A protein search object holds only the standard search object fields.
     *
    ...
    /**
     * This method creates a Lucene document from a cv search object.
     * A cv search object holds only the standard search object fields.
     *
    ...
    /**
     * This method creates a Lucene document from an Interaction search object.
     * An interaction search object has in addition to the standard search objects fields,
     * the fields that describe the interaction type.
    ...
    /**
     * This method creates a Lucene document from an Experiment search object.
     * An experiment search object has in addition to the standard search objects fields,
     * the fields that describe the interaction detection method and the participant detection method.
    ...
    /**
     * This method creates a Lucene document from a biosource search object.
     * A biosource search object holds only the standard search object fields.
     *
    ...
    /**
     * This method creates a lucene document for a specific experiment search object and adds that document to the index..
     * The created document contains the standard fields, like ac, shortlabel, fullname, xrefs and annotation.
    ...
    /**
     * This method creates a lucene document for a specific interaction search object and adds that document to the index.
     * The created document contains the standard fields, like ac, shortlabel, fullname, xrefs and annotation.
     * In addition to that fields for the CvInteractionType are also added to the document.
     *
     * It was used for the trivial indexing, but not for the RAM indexing.
     ...
     * The created document contains the standard fields, like ac, shortlabel, fullname, xrefs and annotation.
     * At the  moment there are no additional fields.
     *
     * It was used for the trivial indexing, but not for the RAM indexing.
    ...
    /**
     * This method creates a lucene document for a specific cv search object and adds that document to the index.
     * The created document contains the standard fields, like ac, shortlabel, fullname, xrefs and annotation.
     * At the  moment there are no additional fields.
     *
     * It was used for the trivial indexing, but not for the RAM indexing.
    ...
    /**
     * This method fills the document (first argument) with the information of the search object (second argument).
     * It just fills the standard fields that are in all search objects
     *
    ...
    /**
     * This method adds all annotation fields to the Lucene document.
     * The information about the annotations is given in a Map, as an argument. The key of the map
     * is always the fieldname (annotation topic) and the value is a collection of annotaions to fill the field.
     * The key will be the name of the field and the annotation is the content to be searched for in the index.
     *
     * @param doc          document to hold the fields
     * @param annotations  Map containing annotation information. The key is the topic name and the value the annotation.
    ...
    /**
     * This method adds all cross reference fields to the given Lucene document.
     * The xref information is stored in a Map, which key is the name of the database
     * and the value is a list of primaryIDs. The key is going to be the field name and the primaryIDs
     * are the content of the field to be searched for in the index.
     *
     * @param doc    document to hold the fields
     * @param xrefs  Map containing cross reference information. The key is the name of the database
     *               and the value is a list of all primaryIDs
    ...
    /**
     * This method adds all alias fields to the given Lucene document.
     * The alias information is stored in a Map, which key is the type of the alias
     * and the value is a list of the names of the alias. The key is going to be the field name and the alias names
     * are the content of the field to be searched for in the index.
     *
     * @param doc    document to hold the fields
     * @param alias  Map containing alias information. The key is the type of the alias
     *               and the value is a list of all alias names
    ...
    /**
     * This method was used for the trivial indexing. It gets a lucene document and adds this document to
     * the lucene index.
     *
    ...
    /**
     * This method was used with the indexing using threads. It merges the given temporary index directory (dir)
     * to the final index directory (index).
     *
