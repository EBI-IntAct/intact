...
public class SearchEngineImpl implements SearchEngine {
     ...
     * @return a  Map containing the results, the keys in the Map are the ac number of the search objects and
...
//                logger.info("found doc: " + doc.toString());
    ...
    /**
     * This method gets a Map containing the result with the ac number as key and the objectclass as value
     * and takes the corresponding intact objects out of the database.
     *
     ...
     * out of the database and creates then the index of these objects.
     * This is a very trivial (first) version it writes everything on scratch without using the RAM.
     * It is recommanded to use instead the method 'createLuceneIndex'
     *
     * @param aSearchObject
     */
    ...
    /**
     * this method created an Lucene index out of the intact objects.
     * It writes the index first into RAM and writes it at the end into the directory
     */
