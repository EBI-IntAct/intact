...
public abstract class CvObject extends AnnotatedObjectImpl {
    ...
    /**
     * Equality for CvObject is currently based on equality for primary id of Xref
     * having the qualifier of identity and short label if there is xref of identity.
     * We need to equals method to avoid circular references when invoking
     * equals methods
     *
     * @param obj The object to check
     * @return true if given object has an identity xref and its primary id matches
     *         to this' object's primary id or short label if there is no identity xref.
