   ...
   /**
    ...
    public boolean equals(Object o) {
        ...
        if(cvInteractionType != null) {
            if (!cvInteractionType.equals(interaction.cvInteractionType)) return false;
        }
        else {
            if (interaction.cvInteractionType != null) return false;
        }

        if(kD != null) {
            if (!kD.equals(interaction.kD)) return false;
        }
        else {
            if (interaction.kD != null) return false;
        }
