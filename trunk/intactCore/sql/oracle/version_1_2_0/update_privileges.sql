...
-- IA_Pub2Exp
PROMPT Creating table "Updating rights on IA_Pub2Exp"
grant select on IA_Pub2Exp to INTACT_SELECT;
grant select, insert,update,delete on IA_Pub2Exp to INTACT_CURATOR;
...
PROMPT Creating table "Updating rights on IA_Pub2Exp_audit"
grant select on IA_Pub2Exp_audit to INTACT_SELECT;
grant select, insert,update,delete on IA_Pub2Exp_audit to INTACT_CURATOR;
