...
<script language="javascript" type="text/javascript">
 function SendInfo(theValue){
     //var txtVal = theValue;
     //window.opener.document.advancedForm.cvInteraction.value = txtVal;
     var options = window.opener.document.advancedForm["cvInteraction"];
...
<br><br><input type='button' onclick='javascript:window.close();' name="button" value="CLOSE" />
</form>
</body>
</html>
