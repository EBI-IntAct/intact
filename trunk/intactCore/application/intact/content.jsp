                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tbody>
                      <tr>
                        ...
                        <span class="pbold"><a name="aims"></a>Project description</span>
                        <ul>
                          <li class="greenboldsmalllist"><span class="text">
                                IntAct provides a freely available, open source database
                                system and analysis tools for protein interaction data. All
                                interactions are derived from literature curation or direct user
                                submissions and are freely available.<br>
                            </span></li>
                        </ul>
                        ...
                        <span class="pbold"><a name="members"></a>Members of the IntAct consortium:</span>
                        <ul>
                          <li class="greenboldsmalllist"><span class="text"> <a href="http://www.ebi.ac.uk/index.html">EBI</a> - European Bioinformatics Institute, Cambridge, United Kingdom</span></li>
                          ...
                          <li class="greenboldsmalllist"><span class="text"><a href="http://mint.bio.uniroma2.it/mint/">MINT</a> - University Tor Vergata, Rome, Italy</span></li>
                        </ul>
                        <br>
                        ...
                        <br>
                        <ul>
                            IntAct is an open source project hosted on SourceForge. You can access
                        ...
                        <span class="pbold"><a name="data" id="stat"></a>Data:</span><br>
                        <ul>
                          <li class="greenboldsmalllist"><span class="text">IntAct is monthly released, normally on the first working day of each month. <br>
                            </span></li>
                        ...
                        <ul>
                          <li class="greenboldsmalllist"><span class="text">All IntAct data and software is freely available to all users, academic or commercial, under the terms of the </span>
                            <a href="http://www.apache.org/licenses/LICENSE-2.0.html">Apache License, Version 2.0.</a><span class="text"><br>
                            </span></li>
                        </ul>
                        <span class="pbold"><a name="status"></a>Status:</span>
                        <br>
                        <ul>
                          <li class="greenboldsmalllist"><span class="text">Source code release 0.8 on April 1st, 2004.<br>
                            </span></li>
                          <li class="greenboldsmalllist"><span class="text">Monthly XML data release since February 1st, 2004. </span></li>
                          <li class="greenboldsmalllist"><span class="text">Production since summer 2003.</span></li>
                        </ul>
                        ...
                        <ul>
                          <li class="greenboldsmalllist"><span class="text">intact-announce@lists.sourceforge.net <br>
                                General IntAct announcements. Low traffic.
                                <a href="http://lists.sourceforge.net/lists/listinfo/intact-announce">Subscribe/unsubscribe</a> here.<br>
                            </span> </li>
                          <li class="greenboldsmalllist">
                            <span class="text">You might also want to submit a <a href="http://sourceforge.net/tracker/?group_id=62732">feature request or bug report</a>.</span> <br>
                          </li>
                        </ul>
                        <div align="right"><a href="#a0"><img src="http://www.ebi.ac.uk/Information/images/arrow_up2.gif" border="0" height="21" width="19"></a><br>
                        <table border="0" cellpadding="0" cellspacing="0" width="434">
                        ...
                        <span class="pbold"><a name="publications"></a>Publications:</span>
                        <ul>
                          <li class="greenboldsmalllist">
                            <span class="text">IntAct - an open source molecular interaction database. <br>
                                               H. Hermjakob, L. Montecchi-Palazzi, C. Lewington, S. Mudali, S.
                                               Kerrien, S. Orchard, M. Vingron, B. Roechert, P. Roepstorff, A.
                                               Valencia, H. Margalit, J. Armstrong, A. Bairoch, G. Cesareni, D.
                                               Sherman, R. Apweiler.
                                               <br>
                                               Nucl. Acids. Res. 2004 32: D452-D455.
                                               <a href="http://nar.oupjournals.org/cgi/content/abstract/32/suppl_1/D452">[Abstract]</a>
                                               <a href="http://nar.oupjournals.org/cgi/content/full/32/suppl_1/D452">[Full Text]</a> </span></li>
                          <br>
                        </ul>
                        <div align="right"><a href="#a0"><img src="http://www.ebi.ac.uk/Information/images/arrow_up2.gif" border="0" height="21" width="19"></a><br>
                        <table border="0" cellpadding="0" cellspacing="0" width="434">
                        ...
                        <span class="pbold"><a name="publications"></a>Related Publications:</span>
                        <ul>
                          <li class="greenboldsmalllist">
                            <span class="text">
                                The HUPO PSI Molecular Interaction Format - A community
                                standard for the representation of protein interaction data.<br>
                                Henning Hermjakob, Luisa Montecchi-Palazzi, Gary Bader,
                                J&eacute;r&ocirc;me Wojcik, Lukasz Salwinski, Arnaud Ceol, Susan Moore,
                                Sandra Orchard, Ugis Sarkans, Christian von Mering, Bernd Roechert,
                                Sylvain Poux, Eva Jung, Henning Mersch, Paul Kersey, Michael Lappe,
                                Yixue Lix, Rong Zeng, Debashis Rana, Macha Nikolski, Holger Husi,
                                Christine Brun, K. Shanker, Seth G.N. Grant, Chris Sander, Peer Bork,
                                Weimin Zhu, Akhilesh Pandey, Alvis Brazma, Bernard Jacq, Marc Vidal,
                                David Sherman, Pierre Legrain, Gianni Cesareni, Ioannis Xenarios, David
                                Eisenberg, Boris Steipe, Chris Hogue, Rolf Apweiler.<br>
                                Nature Biotechnology 22, 2004: 177-183 [PubMed
                                <a href="http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?cmd=Retrieve&amp;db=PubMed&amp;list_uids=14755292&amp;dopt=Abstract">14755292</a>]
                                <br> </span> </li>
                          <li class="greenboldsmalllist">
                                <span class="text">
                                The Proteomics Standards Initiative.<br>
                                Sandra Orchard, Henning Hermjakob, Rolf Apweiler.<br>
                                Proteomics 7, 2003. Pages: 1374-1376. <br>
                            <a href="http://www3.interscience.wiley.com/cgi-bin/abstract/104546402/START">http://www3.interscience.wiley.com/cgi-bin/abstract/104546402/START</a><br>
                            </span> </li>
                          <li class="greenboldsmalllist">
                            <span class="text">
                                Progress in establishing common standards for exchanging
                                proteomics data:<br>
                                The second meeting of the HUPO Proteomics Standards Initiative.<br>
                                Sandra Orchard, Paul Kersey, Weimin Zhu, Luisa Montecchi-Palazzi,
                                Henning Hermjakob, Rolf Apweiler.<br>
                                Comparative and Functional Genomics Volume 4, Issue 2, 2003. Pages:
                                203-206<br>
                            <a href="http://www3.interscience.wiley.com/cgi-bin/abstract/104087808/START">http://www3.interscience.wiley.com/cgi-bin/abstract/104087808/START</a>
                            </span> </li>
                          <li class="greenboldsmalllist">
                            <span class="text">
                                The HUPO Proteomics Standards Initiative meeting: towards
                                common standards for exchanging proteomics data<br>
                                Sandra Orchard, Paul Kersey, Henning Hermjakob, Rolf Apweiler<br>
