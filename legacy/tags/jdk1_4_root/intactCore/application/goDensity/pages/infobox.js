...
//
// - @author Klaus Knopper (infobox@knopper.net)
// - @author modified by Markus Brosch (markus @ brosch.cc)
// - @version $Id$
//

var IWIDTH=235  // Tip box width
...
function maketip(name,title,text){
 //DON'T EXPAND this line and WRAP it !!!
 if(hascss()) document.write('<div id="'+name+'" name="'+name+'" style="position:absolute; visibility:hidden; z-index:20; top:0'+px+'; left:0'+px+';"><table width='+IWIDTH+' border=0 cellpadding=2 cellspacing=0 bgcolor="grey"><tr><td><table width="100%" border=0 cellpadding=0 cellspacing=0><tr><th><font color="#FFFFFF" size="-1">'+title+'</font></th></tr></table><table width="100%" border=0 cellpadding=2 cellspacing=0 bgcolor="lightyellow"><tr><td><font color="#000000" size="-1">'+text+'</font></td></tr></table></td></tr></table></div>'+"\n");
}
