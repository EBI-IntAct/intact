...
//        ourBeanToChunkedView.put( Experiment.class, ExperimentChunkedSingleViewBean.class );
    ...
    /**
     * Builds a tabbed view for a single result. NB this could be refactored by using a User object as a parameter
     * instead, to avoid needing a special method.
     *
     * @param object        an annotated object
     * @param link          a link
     * @param contextPath   the application path.
     * @param maxChunk      an int
     * @param selectedChunk an int
     *
     * @return bean containing a chunk of the data.
     */
     ...
     * <code>AnnotatedObject</code>. NB This chould be refactored using a User object to avoid the need for a seperate
     * special method for a single tabbed view.
     *
