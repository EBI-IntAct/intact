...
//    }
     ...
     *                 uk.ac.ebi.intact.application.search3.business.Constants.MAX_CHUNK_SIZE)
    ...
    public void buildChunkIndex ( Object object,
        ...
        int from = ( (currentChunk - 1) * uk.ac.ebi.intact.application.search3.business.Constants.MAX_PAGE_SIZE ) + 1;
