    ...
    public final void insertComponent( Interaction act,
        ...
        if ( createdProteins.containsKey( spAc ) ) {
            ...
            if ( 0 == proteins.size() ) {
                ...
                Collection<Protein> uniprotProteins = proteinFactory.insertSPTrProteins( spAc );
                if ( uniprotProteins == null ) {
                    System.err.println( "Could not find Protein by UniProt ID: " + spAc );
                } else {
                    proteins.addAll( uniprotProteins );
                }
