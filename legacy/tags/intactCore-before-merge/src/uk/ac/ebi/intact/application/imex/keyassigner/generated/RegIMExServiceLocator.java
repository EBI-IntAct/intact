...
public class RegIMExServiceLocator extends org.apache.axis.client.Service
        implements uk.ac.ebi.intact.application.imex.keyassigner.generated.RegIMExService {
    ...
    public uk.ac.ebi.intact.application.imex.keyassigner.generated.RegIMEx_PortType getRegIMEx() throws javax.xml.rpc.ServiceException {
    ...
    public uk.ac.ebi.intact.application.imex.keyassigner.generated.RegIMEx_PortType getRegIMEx( java.net.URL portAddress ) throws javax.xml.rpc.ServiceException {
        try {
            uk.ac.ebi.intact.application.imex.keyassigner.generated.RegIMExSoapBindingStub _stub = new uk.ac.ebi.intact.application.imex.keyassigner.generated.RegIMExSoapBindingStub( portAddress, this );
    ...
    public java.rmi.Remote getPort( Class serviceEndpointInterface ) throws javax.xml.rpc.ServiceException {
        try {
            if ( uk.ac.ebi.intact.application.imex.keyassigner.generated.RegIMEx_PortType.class.isAssignableFrom( serviceEndpointInterface ) )
            {
                uk.ac.ebi.intact.application.imex.keyassigner.generated.RegIMExSoapBindingStub _stub = new uk.ac.ebi.intact.application.imex.keyassigner.generated.RegIMExSoapBindingStub( new java.net.URL( RegIMEx_address ), this );
                _stub.setPortName( getRegIMExWSDDServiceName() );
                return _stub;
            }
        }
