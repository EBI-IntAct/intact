 ...
 * $Id$
 */
package uk.ac.ebi.intact.struts.framework.util.test;

import java.util.*;
import java.io.*;

import junit.framework.*;
import uk.ac.ebi.intact.struts.framework.util.IntactTypesGenerator;
...
public class IntactTypesGeneratorTest extends TestCase {
    ...
    public void testDoIt() {
        ...
        String resPath = "./src/uk/ac/ebi/intact/struts/framework/util/test/";
