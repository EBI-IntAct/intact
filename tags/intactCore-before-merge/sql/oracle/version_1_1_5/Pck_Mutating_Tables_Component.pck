CREATE OR REPLACE PACKAGE Pck_Mutating_Tables_Component IS
...
END Pck_Mutating_Tables_Component;
/
CREATE OR REPLACE PACKAGE BODY Pck_Mutating_Tables_Component IS
