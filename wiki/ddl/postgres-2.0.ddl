...
create table ia_component (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bool not null, owner_ac varchar(255) not null, fullName varchar(1000), shortLabel varchar(256) not null, expressedin_ac varchar(255), interaction_ac varchar(255), interactor_ac varchar(255), stoichiometry float4 not null, biologicalrole_ac varchar(30), primary key (ac));
...
create table ia_component_parameter (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bool not null, owner_ac varchar(255) not null, base int4, exponent int4, factor float8, uncertainty float8, parametertype_ac varchar(30), parameterunit_ac varchar(30), experiment_ac varchar(30), component_ac varchar(30), primary key (ac));
...
create table ia_confidence (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bool not null, owner_ac varchar(255) not null, value varchar(255), confidencetype_ac varchar(30), interaction_ac varchar(30), primary key (ac));
...
create table ia_imex_export (id int8 not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deleted timestamp, deleted_user varchar(30), imex_id varchar(16) not null unique, publicationId varchar(16) not null, ac varchar(30), primary key (id));
...
create table ia_institution (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bool not null, owner_ac varchar(255) not null, fullName varchar(1000), shortLabel varchar(256) not null, postalAddress varchar(255), url varchar(255), primary key (ac));
...
create table ia_interaction_parameter (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bool not null, owner_ac varchar(255) not null, base int4, exponent int4, factor float8, uncertainty float8, parametertype_ac varchar(30), parameterunit_ac varchar(30), experiment_ac varchar(30), interaction_ac varchar(30), primary key (ac));
create table ia_interactions (graphId int4 not null, interaction_ac varchar(255), protein1_ac varchar(255), protein2_ac varchar(255), pubmed_id varchar(255), shortLabel1 varchar(30), shortLabel2 varchar(30), taxid varchar(30), weight float8 not null, detectmethod_ac varchar(30), experiment_ac varchar(30), primary key (interaction_ac, protein1_ac, protein2_ac));
create table ia_interactor (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bool not null, owner_ac varchar(255) not null, fullName varchar(1000), shortLabel varchar(256) not null, objclass varchar(255), crc64 varchar(255), KD float4, interactiontype_ac varchar(255), biosource_ac varchar(30), interactortype_ac varchar(30), primary key (ac));
...
create table ia_publication (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bool not null, owner_ac varchar(255) not null, fullName varchar(1000), shortLabel varchar(256) not null, primary key (ac));
