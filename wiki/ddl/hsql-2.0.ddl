create table ia_annotation (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, description varchar(4000), topic_ac varchar(30), primary key (ac));
create table ia_biosource (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, fullName varchar(1000), shortLabel varchar(256) not null, celltype_ac varchar(255), tissue_ac varchar(255), taxId varchar(30), primary key (ac));
create table ia_biosource2annot (biosource_ac varchar(30) not null, annotation_ac varchar(30) not null);
create table ia_biosource_alias (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, name varchar(256), aliastype_ac varchar(30), parent_ac varchar(255), primary key (ac));
create table ia_biosource_xref (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, dbRelease varchar(255), primaryId varchar(255), secondaryId varchar(30), database_ac varchar(30), qualifier_ac varchar(30), parent_ac varchar(255), primary key (ac));
create table ia_component (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, fullName varchar(1000), shortLabel varchar(256) not null, expressedin_ac varchar(255), interaction_ac varchar(255), interactor_ac varchar(255), stoichiometry float not null, biologicalrole_ac varchar(30), primary key (ac));
...
create table ia_component2exprole (component_ac varchar(30) not null, experimentalrole_ac varchar(30) not null);
create table ia_component2part_detect (component_ac varchar(30) not null, cvobject_ac varchar(30) not null);
create table ia_component_alias (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, name varchar(256), aliastype_ac varchar(30), parent_ac varchar(255), primary key (ac));
create table ia_component_parameter (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, base integer, exponent integer, factor double, uncertainty double, parametertype_ac varchar(30), parameterunit_ac varchar(30), experiment_ac varchar(30), component_ac varchar(30), primary key (ac));
create table ia_component_xref (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, dbRelease varchar(255), primaryId varchar(255), secondaryId varchar(30), database_ac varchar(30), qualifier_ac varchar(30), parent_ac varchar(255), primary key (ac));
create table ia_confidence (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, value varchar(255), confidencetype_ac varchar(30), interaction_ac varchar(30), primary key (ac));
create table ia_controlledvocab (objclass varchar(255) not null, ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, fullName varchar(1000), shortLabel varchar(256) not null, identifier varchar(30), primary key (ac), unique (objclass, shortLabel));
create table ia_controlledvocab_alias (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, name varchar(256), aliastype_ac varchar(30), parent_ac varchar(255), primary key (ac));
create table ia_controlledvocab_xref (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, dbRelease varchar(255), primaryId varchar(255), secondaryId varchar(30), database_ac varchar(30), qualifier_ac varchar(30), parent_ac varchar(255), primary key (ac), unique (parent_ac, qualifier_ac, database_ac, primaryId));
...
create table ia_db_info (dbi_key varchar(50) not null, created_date timestamp not null, created_user varchar(30) not null, updated_date timestamp not null, updated_user varchar(30) not null, value varchar(512), primary key (dbi_key));
create table ia_exp2annot (experiment_ac varchar(30) not null, annotation_ac varchar(30) not null);
create table ia_experiment (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, fullName varchar(1000), shortLabel varchar(256) not null, biosource_ac varchar(255), detectmethod_ac varchar(255), identmethod_ac varchar(30), publication_ac varchar(30), relatedexperiment_ac varchar(30), primary key (ac));
create table ia_experiment_alias (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, name varchar(256), aliastype_ac varchar(30), parent_ac varchar(255), primary key (ac));
create table ia_experiment_xref (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, dbRelease varchar(255), primaryId varchar(255), secondaryId varchar(30), database_ac varchar(30), qualifier_ac varchar(30), parent_ac varchar(255), primary key (ac));
create table ia_feature (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, fullName varchar(1000), shortLabel varchar(256) not null, linkedfeature_ac varchar(30), component_ac varchar(30), identification_ac varchar(30), featuretype_ac varchar(30), primary key (ac));
create table ia_feature2annot (feature_ac varchar(30) not null, annotation_ac varchar(30) not null);
create table ia_feature_alias (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, name varchar(256), aliastype_ac varchar(30), parent_ac varchar(255), primary key (ac));
create table ia_feature_xref (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, dbRelease varchar(255), primaryId varchar(255), secondaryId varchar(30), database_ac varchar(30), qualifier_ac varchar(30), parent_ac varchar(255), primary key (ac));
create table ia_imex_export (id bigint not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deleted timestamp, deleted_user varchar(30), imex_id varchar(16) not null, publicationId varchar(16) not null, ac varchar(30), primary key (id), unique (imex_id));
create table ia_imex_import (id bigint not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, activationType varchar(255), count_failed integer, count_not_found integer, count_total integer, import_date timestamp, repository varchar(255), primary key (id));
create table ia_imex_import_pub (pmid varchar(50) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, message longvarchar, original_filename varchar(255), release_date timestamp, status varchar(255), imexImport_id bigint, provider_ac varchar(30), primary key (imexImport_id, pmid));
create table ia_institution (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, fullName varchar(1000), shortLabel varchar(256) not null, postalAddress varchar(255), url varchar(255), primary key (ac));
create table ia_institution2annot (institution_ac varchar(30) not null, annotation_ac varchar(30) not null);
create table ia_institution_alias (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, name varchar(256), aliastype_ac varchar(30), parent_ac varchar(255), primary key (ac));
create table ia_institution_xref (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, dbRelease varchar(255), primaryId varchar(255), secondaryId varchar(30), database_ac varchar(30), qualifier_ac varchar(30), parent_ac varchar(255), primary key (ac));
...
create table ia_interaction_parameter (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, base integer, exponent integer, factor double, uncertainty double, parametertype_ac varchar(30), parameterunit_ac varchar(30), experiment_ac varchar(30), interaction_ac varchar(30), primary key (ac));
create table ia_interactions (graphId integer not null, interaction_ac varchar(255), protein1_ac varchar(255), protein2_ac varchar(255), pubmed_id varchar(255), shortLabel1 varchar(30), shortLabel2 varchar(30), taxid varchar(30), weight double not null, detectmethod_ac varchar(30), experiment_ac varchar(30), primary key (interaction_ac, protein1_ac, protein2_ac));
create table ia_interactor (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, fullName varchar(1000), shortLabel varchar(256) not null, objclass varchar(255), crc64 varchar(255), KD float, interactiontype_ac varchar(255), biosource_ac varchar(30), interactortype_ac varchar(30), primary key (ac));
create table ia_interactor_alias (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, name varchar(256), aliastype_ac varchar(30), parent_ac varchar(255), primary key (ac));
create table ia_interactor_xref (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, dbRelease varchar(255), primaryId varchar(255), secondaryId varchar(30), database_ac varchar(30), qualifier_ac varchar(30), parent_ac varchar(255), primary key (ac));
create table ia_payg (nid varchar(20) not null, species varchar(30) not null, bait integer not null, econf integer not null, eseen integer not null, inDegree integer not null, outDegree float not null, prey integer not null, really_used_as_bait char(1), primary key (nid, species));
create table ia_payg_current_edge (nidA varchar(20) not null, nidB varchar(20) not null, species varchar(20) not null, conf integer not null, seen integer not null, primary key (nidA, nidB, species));
...
create table ia_publication (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, fullName varchar(1000), shortLabel varchar(256) not null, primary key (ac));
create table ia_publication_alias (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, name varchar(256), aliastype_ac varchar(30), parent_ac varchar(255), primary key (ac));
create table ia_publication_xref (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, dbRelease varchar(255), primaryId varchar(255), secondaryId varchar(30), database_ac varchar(30), qualifier_ac varchar(30), parent_ac varchar(255), primary key (ac));
create table ia_range (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bit not null, owner_ac varchar(255) not null, fromIntervalEnd integer not null, fromIntervalStart integer not null, link char(1), sequence varchar(255), toIntervalEnd integer not null, toIntervalStart integer not null, undetermined char(1) not null, feature_ac varchar(30), fromfuzzytype_ac varchar(30), tofuzzytype_ac varchar(30), primary key (ac));
create table ia_sequence_chunk (ac varchar(255) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, parent_ac varchar(255), sequence_chunk varchar(1000), sequence_index integer, primary key (ac));
