...
public class InstitutionAgitarTest extends AgitarTestCase {
    ...
    public void testConstructor() throws Throwable {
        ...
        assertEquals( "institution.shortLabel", "XXXXXXXXXXXXXXX\rXXX#", institution.shortLabel );
    }

    public void testConstructor1() throws Throwable {
        Institution institution = new Institution( "21CharactersXXXXXXXXX" );
        assertEquals( "institution.shortLabel", "21CharactersXXXXXXXX", institution.shortLabel );
    }

    public void testConstructor2() throws Throwable {
        Institution institution = new Institution( "testString" );
        assertEquals( "institution.shortLabel", "testString", institution.shortLabel );
    }
    ...
    public void testHashCode() throws Throwable {
        ...
        assertEquals( "institution.shortLabel", "testInstitutionShort", institution.shortLabel );
        assertEquals( "institution.fullName", "testInstitutionFullName", institution.fullName );
    }
    ...
    public void testHashCode1() throws Throwable {
        ...
        assertEquals( "institution.shortLabel", "testInstitutionShort", institution.shortLabel );
        assertNull( "institution.fullName", institution.fullName );
    }
    ...
    public void testSetPostalAddress() throws Throwable {
        Institution institution = new Institution( "testInstitutionShortLabel" );
        institution.setPostalAddress( "testInstitutionPostalAddress" );
        assertEquals( "institution.postalAddress", "testInstitutionPostalAddress", institution.postalAddress );
    }

    public void testSetShortLabel() throws Throwable {
        Institution institution = new Institution( "testInstitutionShortLabel" );
        institution.setShortLabel( "testInstitutionShortLabel" );
        assertEquals( "institution.shortLabel", "testInstitutionShortLabel", institution.shortLabel );
    }

    public void testSetUrl() throws Throwable {
        Institution institution = new Institution( "testInstitutionShortLabel" );
        institution.setUrl( "testInstitutionUrl" );
        assertEquals( "institution.url", "testInstitutionUrl", institution.url );
    }
    ...
    public void testHashCodeThrowsNullPointerException() throws Throwable {
        ...
        try {
            ...
            assertNull( "ex.getMessage()", ex.getMessage() );
            assertThrownBy( Institution.class, ex );
            assertNull( "institution.shortLabel", institution.shortLabel );
            assertNull( "institution.fullName", institution.fullName );
        }
    }
}
