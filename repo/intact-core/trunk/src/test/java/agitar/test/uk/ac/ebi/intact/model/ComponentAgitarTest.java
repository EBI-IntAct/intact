...
public class ComponentAgitarTest extends AgitarTestCase {
    ...
    public void testConstructor() throws Throwable {
        ...
        CvComponentRole role = new CvComponentRole( new Institution( "testComponentShortLabel2" ), "testComponentShortLabel" );
        ...
        assertEquals( "component.shortLabel", "N/A", component.shortLabel );
    ...
    public void testConstructor1() throws Throwable {
        ...
        CvComponentRole role = new CvComponentRole( owner, "testComponentShortLabel" );
    ...
    public void testClone1() throws Throwable {
        ...
        Component component = new Component( owner, interaction, interactor, new CvComponentRole( new Institution( "testComponentShortLabel1" ), "testComponentShortLabel" ) );
        Component result = ( Component ) component.clone();
        assertNull( "result.getCvComponentRoleAc()", result.getCvComponentRoleAc() );
        assertNull( "component.getInteractionAc()", component.getInteractionAc() );
        assertSame( "component.getInteraction()", interaction, component.getInteraction() );
...
//    }
    ...
    public void testHasStoichiometry() throws Throwable {
        Component component = new Component( null, "testComponentShortLabel", ( Interaction ) Mockingbird.getProxyObject( Interaction.class ), ( Interactor ) Mockingbird.getProxyObject( Interactor.class ), ( CvComponentRole ) Mockingbird.getProxyObject( CvComponentRole.class ) );
        Mockingbird.enterTestMode();
    ...
    public void testHashCode() throws Throwable {
        CvComponentRole role = new CvComponentRole( new Institution( "testComponentShortLabel" ), "testComponentShortLabel" );
    ...
    public void testSetBindingDomains() throws Throwable {
        ...
        Component component = new Component( new Institution( "testComponentShortLabel1" ), new InteractionImpl( new ArrayList( 1000 ), new CvInteractionType( new Institution( "testComponent\rShortLabel" ), "testComponentShortLabel1" ), "testComponentShortLabel", new Institution( "testComponent\nShortLabel" ) ), new InteractionImpl( new ArrayList( 0 ), new CvInteractionType( ( Institution ) new Institution( "testComponentShortLabel" ).clone(), "testComponentShortLabel" ), "testComponentShortLabel1", null ), new CvComponentRole( new Institution( "testComponentShortLabel2" ), "testComponentShortLabel" ) );
    ...
    public void testSetCvComponentRole() throws Throwable {
        ...
        Component component = new Component( new Institution( "testComponentShortLabel1" ), interaction, new Complex(), new CvComponentRole( null, "testComponentShortLabel" ) );
        CvComponentRole cvComponentRole = new CvComponentRole( new Institution( "testComponentShortLabel2" ), "testComponentShortLabel1" );
    ...
    public void testSetInteraction() throws Throwable {
        ...
        Component component = new Component( new Institution( "testComponent\nShortLabel" ), "testComponentShortLabel", interaction, interactor, new CvComponentRole( new Institution( "testComponentShortLabel2" ), "testComponentShortLabel" ) );
    ...
    public void testSetInteractionForClone() throws Throwable {
        ...
        Component component = new Component( new Institution( "testComponent\nShortLabel" ), "testComponentShortLabel", new InteractionImpl( new HashSet(), new CvInteractionType( owner, "testComponentShortLabel" ), new CvInteractorType( new Institution( "testComponentShortLabel1" ), "testComponentShortLabel" ), "testComponentShortLabel", ( Institution ) null ), interactor, new CvComponentRole( new Institution( "testComponentShortLabel2" ), "testComponentShortLabel" ) );
        component.setInteractionForClone( interactor );
    ...
    public void testConstructorThrowsIllegalArgumentException() throws Throwable {
        ...
        Interaction interaction = ( Interaction ) Mockingbird.getProxyObject( Interaction.class );
        Interactor interactor = ( Interactor ) Mockingbird.getProxyObject( Interactor.class );
        CvComponentRole role = ( CvComponentRole ) Mockingbird.getProxyObject( CvComponentRole.class );
        Mockingbird.enterTestMode();
        try {
    ...
    public void testConstructorThrowsNullPointerException() throws Throwable {
        try {
            new Component( new Institution( "testComponentShortLabel1" ), "testComponentShortLabel", null, new Complex(), new CvComponentRole( new Institution( "testComponentShortLabel" ), "testComponentShortLabel" ) );
    ...
    public void testConstructorThrowsNullPointerException2() throws Throwable {
        ...
        CvInteractionType type = new CvInteractionType( owner, "testComponentShortLabel" );
        try {
            new Component( new Institution( "testComponentShortLabel2" ), "testComponentShortLabel", new InteractionImpl( new HashSet(), type, new CvInteractorType( new Institution( "testComponentShortLabel1" ), "testComponentShortLabel" ), "testComponentShortLabel", ( Institution ) null ), null, new CvComponentRole( owner, "testComponentShortLabel" ) );
            fail( "Expected NullPointerException to be thrown" );
        } catch ( NullPointerException ex ) {
    ...
    public void testConstructorThrowsNullPointerException3() throws Throwable {
        try {
            new Component( new Institution( "testComponentShortLabel1" ), null, new Complex(), new CvComponentRole( new Institution( "testComponentShortLabel" ), "testComponentShortLabel" ) );
            fail( "Expected NullPointerException to be thrown" );
        } catch ( NullPointerException ex ) {
            assertEquals( "ex.getMessage()", "valid Component must have an Interaction set!", ex.getMessage() );
            assertThrownBy( Component.class, ex );
