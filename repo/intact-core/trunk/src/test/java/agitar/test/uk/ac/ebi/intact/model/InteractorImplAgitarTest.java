...
public class InteractorImplAgitarTest extends AgitarTestCase {
    ...
    public void testHashCode() throws Throwable {
        ...
        assertEquals( "(SmallMoleculeImpl) smallMoleculeImpl.shortLabel", "testInteractorImplSh", ( ( SmallMoleculeImpl ) smallMoleculeImpl ).shortLabel );
        assertNull( "(SmallMoleculeImpl) smallMoleculeImpl.ac", ( ( SmallMoleculeImpl ) smallMoleculeImpl ).ac );
        assertNull( "(SmallMoleculeImpl) smallMoleculeImpl.fullName", ( ( SmallMoleculeImpl ) smallMoleculeImpl ).fullName );
    ...
    public void testHashCode1() throws Throwable {
        ...
        assertNull( "(Complex) complex.shortLabel", ( ( Complex ) complex ).shortLabel );
        assertNull( "(Complex) complex.ac", ( ( Complex ) complex ).ac );
        assertNull( "(Complex) complex.fullName", ( ( Complex ) complex ).fullName );
