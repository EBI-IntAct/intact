...
create table ia_biosource_alias (ac varchar2(30 char) not null, created timestamp not null, created_user varchar2(30 char) not null, updated timestamp not null, userstamp varchar2(30 char) not null, deprecated number(1,0) not null, owner_ac varchar2(255 char) not null, name varchar2(30 char), aliastype_ac varchar2(30 char), parent_ac varchar2(255 char), primary key (ac));
create table ia_biosource_xref (ac varchar2(30 char) not null, created timestamp not null, created_user varchar2(30 char) not null, updated timestamp not null, userstamp varchar2(30 char) not null, deprecated number(1,0) not null, owner_ac varchar2(255 char) not null, dbRelease varchar2(255 char), primaryId varchar2(255 char), secondaryId varchar2(30 char), qualifier_ac varchar2(30 char), database_ac varchar2(30 char), parent_ac varchar2(255 char), primary key (ac));
...
create table ia_component_alias (ac varchar2(30 char) not null, created timestamp not null, created_user varchar2(30 char) not null, updated timestamp not null, userstamp varchar2(30 char) not null, deprecated number(1,0) not null, owner_ac varchar2(255 char) not null, name varchar2(30 char), aliastype_ac varchar2(30 char), parent_ac varchar2(255 char), primary key (ac));
create table ia_component_xref (ac varchar2(30 char) not null, created timestamp not null, created_user varchar2(30 char) not null, updated timestamp not null, userstamp varchar2(30 char) not null, deprecated number(1,0) not null, owner_ac varchar2(255 char) not null, dbRelease varchar2(255 char), primaryId varchar2(255 char), secondaryId varchar2(30 char), qualifier_ac varchar2(30 char), database_ac varchar2(30 char), parent_ac varchar2(255 char), primary key (ac));
...
create table ia_controlledvocab_alias (ac varchar2(30 char) not null, created timestamp not null, created_user varchar2(30 char) not null, updated timestamp not null, userstamp varchar2(30 char) not null, deprecated number(1,0) not null, owner_ac varchar2(255 char) not null, name varchar2(30 char), aliastype_ac varchar2(30 char), parent_ac varchar2(255 char), primary key (ac));
create table ia_controlledvocab_xref (ac varchar2(30 char) not null, created timestamp not null, created_user varchar2(30 char) not null, updated timestamp not null, userstamp varchar2(30 char) not null, deprecated number(1,0) not null, owner_ac varchar2(255 char) not null, dbRelease varchar2(255 char), primaryId varchar2(255 char), secondaryId varchar2(30 char), qualifier_ac varchar2(30 char), database_ac varchar2(30 char), parent_ac varchar2(255 char), primary key (ac), unique (parent_ac, qualifier_ac, database_ac, primaryId));
...
create table ia_experiment (ac varchar2(30 char) not null, created timestamp not null, created_user varchar2(30 char) not null, updated timestamp not null, userstamp varchar2(30 char) not null, deprecated number(1,0) not null, owner_ac varchar2(255 char) not null, fullName varchar2(250 char), shortLabel varchar2(20 char) not null, biosource_ac varchar2(255 char), detectmethod_ac varchar2(255 char), identmethod_ac varchar2(30 char), relatedexperiment_ac varchar2(30 char), publication_ac varchar2(30 char), primary key (ac));
create table ia_experiment_alias (ac varchar2(30 char) not null, created timestamp not null, created_user varchar2(30 char) not null, updated timestamp not null, userstamp varchar2(30 char) not null, deprecated number(1,0) not null, owner_ac varchar2(255 char) not null, name varchar2(30 char), aliastype_ac varchar2(30 char), parent_ac varchar2(255 char), primary key (ac));
create table ia_experiment_xref (ac varchar2(30 char) not null, created timestamp not null, created_user varchar2(30 char) not null, updated timestamp not null, userstamp varchar2(30 char) not null, deprecated number(1,0) not null, owner_ac varchar2(255 char) not null, dbRelease varchar2(255 char), primaryId varchar2(255 char), secondaryId varchar2(30 char), qualifier_ac varchar2(30 char), database_ac varchar2(30 char), parent_ac varchar2(255 char), primary key (ac));
create table ia_feature (ac varchar2(30 char) not null, created timestamp not null, created_user varchar2(30 char) not null, updated timestamp not null, userstamp varchar2(30 char) not null, deprecated number(1,0) not null, owner_ac varchar2(255 char) not null, fullName varchar2(250 char), shortLabel varchar2(20 char) not null, component_ac varchar2(30 char), linkedfeature_ac varchar2(30 char), featuretype_ac varchar2(30 char), identification_ac varchar2(30 char), primary key (ac));
create table ia_feature2annot (feature_ac varchar2(30 char) not null, annotation_ac varchar2(30 char) not null);
create table ia_feature_alias (ac varchar2(30 char) not null, created timestamp not null, created_user varchar2(30 char) not null, updated timestamp not null, userstamp varchar2(30 char) not null, deprecated number(1,0) not null, owner_ac varchar2(255 char) not null, name varchar2(30 char), aliastype_ac varchar2(30 char), parent_ac varchar2(255 char), primary key (ac));
create table ia_feature_xref (ac varchar2(30 char) not null, created timestamp not null, created_user varchar2(30 char) not null, updated timestamp not null, userstamp varchar2(30 char) not null, deprecated number(1,0) not null, owner_ac varchar2(255 char) not null, dbRelease varchar2(255 char), primaryId varchar2(255 char), secondaryId varchar2(30 char), qualifier_ac varchar2(30 char), database_ac varchar2(30 char), parent_ac varchar2(255 char), primary key (ac));
...
create table ia_institution (ac varchar2(30 char) not null, created timestamp not null, created_user varchar2(30 char) not null, updated timestamp not null, userstamp varchar2(30 char) not null, deprecated number(1,0) not null, fullName varchar2(255 char), postalAddress varchar2(255 char), shortLabel varchar2(20 char) not null, url varchar2(255 char), primary key (ac));
create table ia_institution2annot (institution_ac varchar2(30 char) not null, annotation_ac varchar2(30 char) not null);
create table ia_institution_alias (ac varchar2(30 char) not null, created timestamp not null, created_user varchar2(30 char) not null, updated timestamp not null, userstamp varchar2(30 char) not null, deprecated number(1,0) not null, owner_ac varchar2(255 char) not null, name varchar2(30 char), aliastype_ac varchar2(30 char), parent_ac varchar2(255 char), primary key (ac));
create table ia_institution_xref (ac varchar2(30 char) not null, created timestamp not null, created_user varchar2(30 char) not null, updated timestamp not null, userstamp varchar2(30 char) not null, deprecated number(1,0) not null, owner_ac varchar2(255 char) not null, dbRelease varchar2(255 char), primaryId varchar2(255 char), secondaryId varchar2(30 char), qualifier_ac varchar2(30 char), database_ac varchar2(30 char), parent_ac varchar2(255 char), primary key (ac));
...
create table ia_interactor (objclass varchar2(100 char) not null, ac varchar2(30 char) not null, created timestamp not null, created_user varchar2(30 char) not null, updated timestamp not null, userstamp varchar2(30 char) not null, deprecated number(1,0) not null, owner_ac varchar2(255 char) not null, fullName varchar2(250 char), shortLabel varchar2(20 char) not null, crc64 varchar2(255 char), KD float, interactiontype_ac varchar2(255 char), interactortype_ac varchar2(30 char), biosource_ac varchar2(30 char), primary key (ac));
create table ia_interactor_alias (ac varchar2(30 char) not null, created timestamp not null, created_user varchar2(30 char) not null, updated timestamp not null, userstamp varchar2(30 char) not null, deprecated number(1,0) not null, owner_ac varchar2(255 char) not null, name varchar2(30 char), aliastype_ac varchar2(30 char), parent_ac varchar2(255 char), primary key (ac));
create table ia_interactor_xref (ac varchar2(30 char) not null, created timestamp not null, created_user varchar2(30 char) not null, updated timestamp not null, userstamp varchar2(30 char) not null, deprecated number(1,0) not null, owner_ac varchar2(255 char) not null, dbRelease varchar2(255 char), primaryId varchar2(255 char), secondaryId varchar2(30 char), qualifier_ac varchar2(30 char), database_ac varchar2(30 char), parent_ac varchar2(255 char), primary key (ac));
...
create table ia_publication (ac varchar2(30 char) not null, created timestamp not null, created_user varchar2(30 char) not null, updated timestamp not null, userstamp varchar2(30 char) not null, deprecated number(1,0) not null, owner_ac varchar2(255 char) not null, fullName varchar2(250 char), shortLabel varchar2(20 char) not null, primary key (ac));
create table ia_publication_alias (ac varchar2(30 char) not null, created timestamp not null, created_user varchar2(30 char) not null, updated timestamp not null, userstamp varchar2(30 char) not null, deprecated number(1,0) not null, owner_ac varchar2(255 char) not null, name varchar2(30 char), aliastype_ac varchar2(30 char), parent_ac varchar2(255 char), primary key (ac));
create table ia_publication_xref (ac varchar2(30 char) not null, created timestamp not null, created_user varchar2(30 char) not null, updated timestamp not null, userstamp varchar2(30 char) not null, deprecated number(1,0) not null, owner_ac varchar2(255 char) not null, dbRelease varchar2(255 char), primaryId varchar2(255 char), secondaryId varchar2(30 char), qualifier_ac varchar2(30 char), database_ac varchar2(30 char), parent_ac varchar2(255 char), primary key (ac));
create table ia_range (ac varchar2(30 char) not null, created timestamp not null, created_user varchar2(30 char) not null, updated timestamp not null, userstamp varchar2(30 char) not null, deprecated number(1,0) not null, owner_ac varchar2(255 char) not null, fromIntervalEnd number(10,0) not null, fromIntervalStart number(10,0) not null, link char(1 char), sequence varchar2(255 char), toIntervalEnd number(10,0) not null, toIntervalStart number(10,0) not null, undetermined char(1 char) not null, tofuzzytype_ac varchar2(30 char), feature_ac varchar2(30 char), fromfuzzytype_ac varchar2(30 char), primary key (ac));
create table ia_search (ac varchar2(255 char) not null, objClass varchar2(255 char) not null, type varchar2(255 char) not null, value varchar2(255 char) not null, primary key (ac, objClass, type, value));
