...
create table ia_exp_causal_relations_audit (event char(1) not null, id number(19,0) not null, created timestamp, created_user varchar2(30 char), updated timestamp, userstamp varchar2(30 char), relation_type_ac varchar2(30 char) not null, experimental_target_ac varchar2(30 char), modelled_target_ac varchar2(30 char), source_ac varchar2(30 char));

PROMPT Creating table "ia_mod_causal_relations_AUDIT"
create table ia_mod_causal_relations_audit (event char(1) not null, id number(19,0) not null, created timestamp, created_user varchar2(30 char), updated timestamp, userstamp varchar2(30 char), relation_type_ac varchar2(30 char) not null, target_ac varchar2(30 char) not null, source_ac varchar2(30 char));
...
create table ia_variable_parameter_audit (event char(1) not null, id number(19,0) not null, created timestamp, created_user varchar2(30 char), updated timestamp, userstamp varchar2(30 char), description varchar2(255 char), experiment_ac varchar2(30 char), unit_ac varchar2(30 char))

PROMPT Creating table "ia_var_parameter_value_AUDIT"
create table ia_var_parameter_value_audit (event char(1) not null, id number(19,0) not null, created timestamp, created_user varchar2(30 char), updated timestamp, userstamp varchar2(30 char), variableorder number(10,0), value varchar2(255 char), parameter_id number(19,0));

PROMPT Creating table "ia_interaction_varparam_AUDIT"
create table ia_interaction_varparam_audit (event char(1) not null, id number(19,0) not null, created timestamp, created_user varchar2(30 char), updated timestamp, userstamp varchar2(30 char), parent_ac varchar2(30 char))

PROMPT Creating table "ia_varset2paramvalue_AUDIT"
create table ia_varset2paramvalue_audit (event char(1) not null, created timestamp, created_user varchar2(30 char), updated timestamp, userstamp varchar2(30 char), varset_id number(19,0) not null, parametervalue_id number(19,0) not null);

PROMPT Creating table "ia_complex_lcycle_evt_AUDIT"
create table ia_complex_lcycle_evt_audit (event char(1) not null, ac varchar2(30 char) not null, created timestamp, created_user varchar2(30 char), updated timestamp, userstamp varchar2(30 char), note clob, when_date timestamp, event_ac varchar2(30 char) not null, user_ac varchar2(30 char) not null, complex_ac varchar2(30 char))
