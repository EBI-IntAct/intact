...
(       ac                      VARCHAR(30)   NOT NULL
    ...
    ,  updated                 TIMESTAMP            DEFAULT  now() NOT NULL
    ,  userstamp               VARCHAR(30)    DEFAULT  USER    NOT NULL
    ,  aliastype_ac            VARCHAR(30)    CONSTRAINT fk_biosource_alias_qualifier REFERENCES IA_ControlledVocab(ac)
    ,  parent_ac               VARCHAR(30)    CONSTRAINT fk_biosource_alias_biosource  REFERENCES IA_biosource(ac)
    ,  owner_ac                VARCHAR(30)    CONSTRAINT fk_biosource_alias_owner REFERENCES IA_Institution(ac)
    ,  name                    VARCHAR(30)
    , created_user            VARCHAR(30)    DEFAULT  USER    NOT NULL
)
;

CREATE index i_biosource_alias_parent_ac on IA_biosource_alias(parent_ac) 
;
...
(       ac                      VARCHAR(30)   NOT NULL
    ...
    ,  updated                 TIMESTAMP            DEFAULT  now() NOT NULL
    ,  userstamp               VARCHAR(30)    DEFAULT  USER    NOT NULL
    ,  aliastype_ac            VARCHAR(30)    CONSTRAINT fk_cv_alias_qualifier REFERENCES IA_ControlledVocab(ac)
    ,  parent_ac               VARCHAR(30)    CONSTRAINT fk_cv_alias_cv  REFERENCES IA_controlledvocab(ac)
    ,  owner_ac                VARCHAR(30)    CONSTRAINT fk_cv_alias_owner REFERENCES IA_Institution(ac)
    ,  name                    VARCHAR(30)
    , created_user            VARCHAR(30)    DEFAULT  USER    NOT NULL
)
;
CREATE index i_cv_alias_parent_ac on IA_controlledvocab_alias(parent_ac)
;
...
(       ac                      VARCHAR(30)   NOT NULL
    ...
    ,  updated                 TIMESTAMP            DEFAULT  now() NOT NULL
    ,  userstamp               VARCHAR(30)    DEFAULT  USER    NOT NULL
    ,  aliastype_ac            VARCHAR(30)    CONSTRAINT fk_component_alias_qualifier REFERENCES IA_ControlledVocab(ac)
    ,  parent_ac               VARCHAR(30)    CONSTRAINT fk_component_alias_component  REFERENCES IA_component(ac)
    ,  owner_ac                VARCHAR(30)    CONSTRAINT fk_component_alias_owner REFERENCES IA_Institution(ac)
    ,  name                    VARCHAR(30)
    , created_user            VARCHAR(30)    DEFAULT  USER    NOT NULL
)
;

CREATE index i_component_alias_parent_ac on IA_component_alias(parent_ac) 
;
...
(       ac                      VARCHAR(30)   NOT NULL
    ...
    ,  updated                 TIMESTAMP            DEFAULT  now() NOT NULL
    ,  userstamp               VARCHAR(30)    DEFAULT  USER    NOT NULL
    ,  aliastype_ac            VARCHAR(30)    CONSTRAINT fk_feature_alias_qualifier REFERENCES IA_ControlledVocab(ac)
    ,  parent_ac               VARCHAR(30)    CONSTRAINT fk_feature_alias_feature  REFERENCES IA_feature(ac)
    ,  owner_ac                VARCHAR(30)    CONSTRAINT fk_feature_alias_owner REFERENCES IA_Institution(ac)
    ,  name                    VARCHAR(30)
    , created_user            VARCHAR(30)    DEFAULT  USER    NOT NULL
)
;

CREATE index i_feature_alias_parent_ac on IA_feature_alias(parent_ac) 
;
...
(       ac                      VARCHAR(30)   NOT NULL
    ...
    ,  updated                 TIMESTAMP            DEFAULT  now() NOT NULL
    ,  userstamp               VARCHAR(30)    DEFAULT  USER    NOT NULL
    ,  aliastype_ac            VARCHAR(30)    CONSTRAINT fk_interactor_alias_qualifier REFERENCES IA_ControlledVocab(ac)
    ,  parent_ac               VARCHAR(30)    CONSTRAINT fk_interactor_alias_interactor  REFERENCES IA_interactor(ac)
    ,  owner_ac                VARCHAR(30)    CONSTRAINT fk_interactor_alias_owner REFERENCES IA_Institution(ac)
    ,  name                    VARCHAR(30)
    , created_user            VARCHAR(30)    DEFAULT  USER    NOT NULL
)
;

CREATE index i_interactor_alias_parent_ac on IA_interactor_alias(parent_ac)
;
...
(       ac                      VARCHAR(30)   NOT NULL
    ...
    ,  updated                 TIMESTAMP            DEFAULT  now() NOT NULL
    ,  userstamp               VARCHAR(30)    DEFAULT  USER    NOT NULL
    ,  aliastype_ac            VARCHAR(30)    CONSTRAINT fk_experiment_alias_qualifier REFERENCES IA_ControlledVocab(ac)
    ,  parent_ac               VARCHAR(30)    CONSTRAINT fk_experiment_alias_experiment  REFERENCES IA_experiment(ac)
    ,  owner_ac                VARCHAR(30)    CONSTRAINT fk_experiment_alias_owner REFERENCES IA_Institution(ac)
    ,  name                    VARCHAR(30)
    , created_user            VARCHAR(30)    DEFAULT  USER    NOT NULL
)
;
                                
CREATE index i_experiment_alias_parent_ac on IA_experiment_alias(parent_ac)
;
...
(       ac                      VARCHAR(30)   NOT NULL
    ...
    ,  updated                 TIMESTAMP            DEFAULT  now() NOT NULL
    ,  userstamp               VARCHAR(30)    DEFAULT  USER    NOT NULL
    ,  aliastype_ac            VARCHAR(30)    CONSTRAINT fk_publication_alias_qualifier REFERENCES IA_ControlledVocab(ac)
    ,  parent_ac               VARCHAR(30)    CONSTRAINT fk_publication_alias_pub  REFERENCES IA_publication(ac)
    ,  owner_ac                VARCHAR(30)    CONSTRAINT fk_publication_alias_owner REFERENCES IA_Institution(ac)
    ,  name                    VARCHAR(30)
    , created_user            VARCHAR(30)    DEFAULT  USER    NOT NULL
)
;

CREATE index i_publication_alias_parent_ac on IA_publication_alias(parent_ac)
;
