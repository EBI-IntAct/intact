te table ia_annotation (ac varchar(30) not null, created timestamp, created_user varchar(255), updated timestamp, userstamp varchar(255), deprecated bool not null, owner_ac varchar(255) not null, description varchar(4000), topic_ac varchar(30), primary key (ac));
