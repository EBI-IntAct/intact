...
create table ia_interaction_parameter (ac varchar(30) not null, created timestamp not null, created_user varchar(30) not null, updated timestamp not null, userstamp varchar(30) not null, deprecated bool not null, owner_ac varchar(255) not null, base int4, exponent int4, factor float8, uncertainty float8, parameterunit_ac varchar(30), interaction_ac varchar(30), parametertype_ac varchar(30), experiment_ac varchar(30), primary key (ac));
...
create index cvobject_mi_id_idx on ia_controlledvocab (mi_identifier);
