...
public abstract class BinaryItem implements Comparable<BinaryItem> {
    ...
    public int compareTo(BinaryItem other) {
        ...
        Arrays.sort(names1);
        Arrays.sort(names2);
        if (names1[0].equals(names2[0]) ) return names1[1].compareTo(names2[1]);
        else return names1[0].compareTo(names2[0]);
    ...
    public boolean equals(Object other) {
        ...
        if (other == null) return false;
            ...
            if (name1.equals(otherNames[0]) && name2.equals(otherNames[1])) return true;
            else if (name2.equals(otherNames[0]) && name1.equals(otherNames[1])) return true;
            else return false;
        } else return false;
    }
