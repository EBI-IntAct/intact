...
public class ReactomeExport
{
    ...
    public static void exportToReactomeFile(List<ReactomeBean> reactomeBeans, File outputFile) throws ReactomeException
    {
       ...
       if ( reactomeBeans == null ) {
            ...
            log.debug( "IntAct maintain " + reactomeBeans.size() + " Xref" +
                                ( reactomeBeans.size() > 1 ? "s" : "" ) + " to Reactome." );
    ...
    public static ReactomeValidationReport areXrefsFromIntactValid(List<ReactomeBean> xrefsFromIntact, URL url) throws ReactomeException
    {
        ...
        log.debug("Reactome maintain " + xrefsFromReactome.size() + " Xref" +
                (xrefsFromReactome.size() > 1 ? "s" : "") + " to IntAct.");

        // intact's reactome ID MINUS Reactome's
        Collection<String> reactomeIDs = CollectionUtils.subtract(getReactomeIDs(xrefsFromIntact),
        ...
        Collection<String> intactIDs = CollectionUtils.subtract(getIntactIDs(xrefsFromReactome),
