...
public class IntactConfigurator {
     ...
     */
    public void initIntact( IntactSession session ) throws IntactInitializationError {
...
//        context.getDataContext().getDaoFactory().getEntityManager().close();
//
//        return context;
     ...
     */
    public void initializeDatabaseIfNecessary(IntactContext context) {
        try {
     ...
     * @param context IntactContext
     */
    public void initializeDatabase(IntactContext context) {
        try {
    ...
    private void loadInstitution( IntactSession session ) {
    ...
    private void persistInstitutionAndCvsIfNecessary( IntactContext context ) throws IntactTransactionException {
    ...
    private void persistInstitution(IntactContext context) throws IntactTransactionException {
    ...
    private void persistSchemaVersionIfNecessary( IntactContext context ) {
        IntactSession session = context.getSession();
    ...
    private void persistSchemaVersion(IntactContext context) {
        IntactSession session = context.getSession();
    ...
    private void persistBasicCvObjects(IntactContext context) {
    ...
    private DaoFactory getDefaultDaoFactory(IntactContext context) {
        return daoFactory;
    }


    private void setInstitutionToBePersisted( IntactSession session ) {
        session.setApplicationAttribute( INSTITUTION_TO_BE_PERSISTED_FLAG, Boolean.TRUE );
    }

    private void setSchemaVersionToBePersisted( IntactSession session ) {
        session.setApplicationAttribute( SCHEMA_VERSION_TO_BE_PERSISTED_FLAG, Boolean.TRUE );
    }

    private void setInitialized( IntactSession session, boolean initialized ) {
