...
public class DiffUtilsTest {
    ...
    @Test
    public void calculateIndexShift6() throws Exception {
        final String str1 = "ABCD";
        final String str2 = "ZZZFZZZ";
    ...
    @Test
    public void calculateIndexShift7() throws Exception {
        String str1 = "ABCDEF";
        String str2 = "ZZAZZDZFEZZZZZZ";
