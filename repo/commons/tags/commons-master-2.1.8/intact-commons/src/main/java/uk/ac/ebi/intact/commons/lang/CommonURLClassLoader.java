 ...
 */
package uk.ac.ebi.intact.commons.lang;
...
public class CommonURLClassLoader extends URLClassLoader {
    ...
    public CommonURLClassLoader(URL[] urls) {
        super(urls);
        this.urlClasspath = new URLClassPath(urls);
    }

    public CommonURLClassLoader(URL[] urls, ClassLoader parent) {
        super(urls, parent);
        this.urlClasspath = new URLClassPath(urls);
    }

    public CommonURLClassLoader(URL[] urls, ClassLoader parent, URLStreamHandlerFactory factory) {
