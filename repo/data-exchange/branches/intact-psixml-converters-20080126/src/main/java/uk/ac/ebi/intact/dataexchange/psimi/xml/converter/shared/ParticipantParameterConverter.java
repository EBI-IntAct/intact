 ...
 *               </pre>
 */
public class ParticipantParameterConverter extends AbstractIntactPsiConverter<ComponentParameter, psidev.psi.mi.xml.model.Parameter> {

    public ParticipantParameterConverter( Institution institution ) {
        super( institution );
    }

    public ComponentParameter psiToIntact( psidev.psi.mi.xml.model.Parameter psiObject ) {
        ...
        ComponentParameter parameter = new ComponentParameter( getInstitution(), cvParameterType, factor);
    ...
    public psidev.psi.mi.xml.model.Parameter intactToPsi( ComponentParameter intactObject ) {
