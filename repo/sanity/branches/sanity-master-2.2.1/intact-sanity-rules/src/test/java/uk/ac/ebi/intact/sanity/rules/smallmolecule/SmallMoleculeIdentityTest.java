...
public class SmallMoleculeIdentityTest {
    ...
    public void check_identity_is_not_chebi() throws Exception {
        ...
        Assert.assertEquals( MessageDefinition.SMALL_MOLECULE_IDENTITY_INVALID_DB,
    ...
    public void check_many_identities() throws Exception {
        ...
        Assert.assertNotNull( messages );
        Assert.assertEquals( 1, messages.size() );
        Assert.assertEquals( MessageDefinition.SMALL_MOLECULE_IDENTITY_MULTIPLE,
                             messages.iterator().next().getMessageDefinition() );
    }
    ...
    public void check_no_identities() throws Exception {
        ...
        Assert.assertNotNull( messages );
        Assert.assertEquals( 1, messages.size() );
        Assert.assertEquals( MessageDefinition.SMALL_MOLECULE_IDENTITY_MISSING,
                             messages.iterator().next().getMessageDefinition() );
    }
}
