...
public class ReportTopic {
    ...
    public static final ReportTopic CVINTERACTION_WITHOUT_ANNOTATION_UNIPROT_DR_EXPORT = new ReportTopic( "This/those CvInteraction have no uniprot-dr-export annotation" );
    ...
    // P R O T E I N S
    //
    public static final ReportTopic INTERACTOR_WITH_MULTIPLE_IDENTITY = new ReportTopic("Interactor with multiple identity xreferences.");
    ...
    public static final ReportTopic PROTEIN_WITH_NO_UNIPROT_IDENTITY = new ReportTopic( "Interactor with no Xref with XrefQualifier(identity) to and CvDatabase UniprotKb or ddbj-embl-genbank" );
    public static final ReportTopic PROTEIN_WITH_MORE_THAN_ONE_DDBJ_IDENTITY = new ReportTopic( "Nucleic Acid with more than one Xref with XrefQualifier(identity) and CvDatabase(ddbj-embl-genbank)" );
    public static final ReportTopic PROTEIN_WITH_IDENTITY_XREF_TO_DDBJ_AND_UNIPROT = new ReportTopic( "Interactor having one ore more xref identity to Uniprot and one or more xref identity to ddbj-embl-genbank" );
