...
*/
package uk.ac.ebi.intact.sanity.check.util;
 ...
 * @version $Id: AnnotationSection.java,v 1.5 2006/03/29 09:18:08 baranda Exp $
 */
public class AnnotationSection
{
    ...
    public AnnotationSection() throws IntactException {
        ...
        */
        ...
        List<String> usableTopics;

        Collection<CvTopic> cvTopics = IntactContext.getCurrentInstance().getDataContext().getDaoFactory()
                .getCvObjectDao(CvTopic.class).getAll();
