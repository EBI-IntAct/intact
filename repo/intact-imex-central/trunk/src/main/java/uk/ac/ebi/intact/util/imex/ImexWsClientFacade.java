...
public class ImexWsClientFacade {
     ...
     * @throws ImexFacadeException
     */
    public ImexPublication createPublication(String type, String pubmedId, ImexPublicationStatus status,
                                             String title, String author, Date releaseDate, Date expectedPublicationDate,
                                             Date publicationDate, String loginId) throws ImexFacadeException {
     ...
     */
    public void updatePublicationStatus(String pubmedId,ImexPublicationStatus status, String loginId) throws ImexCentralWebserviceException_Exception//IMExCentralSecurityException,NoSuchObjectException
    {
