...
public class ExperimentListGenerator {
    ...
    private static final Log log = LogFactory.getLog(ExperimentListGenerator.class);
        ...
        */
        protected File publicationsFile;
        ...
        */
        ...
        {
            this.targetPath = new File(".");
            this.searchPattern = "%";
            this.speciesFile = new File("classification_"+CURRENT_TIME+"_by_species.txt");
            this.publicationsFile = new File("classification_"+CURRENT_TIME+"_by_publications.txt");
        }

        public void execute()
        {
            log.info("Executing experiment list generator");
            ...
            {
                throw new IntactException("Target species file already exist and overwrite is set to false: "+speciesFile);
            }

            if (publicationsFile.exists() && !overwrite)
            {
                throw new IntactException("Target publications file already exist and overwrite is set to false: "+speciesFile);
            }

            log.debug("Species filename: "+speciesFile);
            log.debug("Publications filename: "+publicationsFile);
            ...
            try
            {
                ...
                log.info( "Using search pattern: " + searchPattern );
            ...
            {
                e.printStackTrace();
                throw new IntactException("Exception when producing the output files", e);
            }
        ...
        public Collection<Experiment> getExperiments( String searchPattern ) throws IntactException
        {
            ...
            log.debug( "done (found " + resultSize + " experiment" + ( resultSize > 1 ? "s" : "" ) + ")" );
        ...
        public ExperimentClassification classifyExperiments( String searchPattern, boolean forcePubmed ) throws IntactException {
            ...
            for (Experiment experiment : searchResults)
            {
                ...
                log.debug("Classifying " + experiment.getShortLabel() + " (" + size + " interaction" + (size > 1 ? "s" : "") + ")");
        ...
        private Set<String> getExperimentWithoutPubmedId( boolean forcePubmed ) throws IntactException {
            ...
            else
            {
                ...
                Map<String,String> expAcAndLabels = ExperimentListGeneratorDao.getExperimentAcAndLabelWithoutPubmedId();
                ...
                log.debug(filter.size() + " experiment filtered out.");
        ...
        private void classifyNegatives( ExperimentClassification classification ) throws IntactException {
            ...
            log.debug( negExps.size() + " negative experiment found." );
        }
        ...
        public void setSpeciesFile(File speciesFile)
        {
            this.speciesFile = speciesFile;
        }

        public File getPublicationsFile()
        {
            return publicationsFile;
        }

        public void setPublicationsFile(File publicationsFile)
        {
