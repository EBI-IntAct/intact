...
public class ExperimentListGeneratorTest extends TestCase
{
    ...
    public void testGenerateListGavin()
    {
        ...
        assertEquals("species/yeast_small-01.xml gavin-2006-1", eliSpecies.get(0).toString());
        assertEquals("species/yeast_small-02.xml gavin-2002-1", eliSpecies.get(1).toString());
        assertEquals("species/yeast_small-03.xml gavin-2006-2", eliSpecies.get(2).toString());
        ...
        assertEquals("pmid/2003/11805826.xml gavin-2002-1", eliPublications.get(0).toString());
        assertEquals("pmid/2005/16429126-01.xml gavin-2006-1", eliPublications.get(1).toString());
        assertEquals("pmid/2005/16429126-02.xml gavin-2006-2", eliPublications.get(2).toString());
    ...
    public void testGenerateListWithNegative()
    {
        ...
        assertEquals(3, eliSpecies.size());
        assertEquals("species/human_small-01.xml lim-2006-2", eliSpecies.get(0).toString());
        assertEquals("species/human_small-02.xml lim-2006-3,lim-2006-1", eliSpecies.get(1).toString());
        assertEquals("species/human_small-02_negative.xml lim-2006-4", eliSpecies.get(2).toString());

        List<ExperimentListItem> eliPublications = gen.generateClassificationByPublications();

        assertEquals(3, eliPublications.size());
        assertEquals("pmid/2006/16713569-01.xml lim-2006-2", eliPublications.get(0).toString());
        assertEquals("pmid/2006/16713569-02.xml lim-2006-3,lim-2006-1", eliPublications.get(1).toString());
        assertEquals("pmid/2006/16713569-02_negative.xml lim-2006-4", eliPublications.get(2).toString());
